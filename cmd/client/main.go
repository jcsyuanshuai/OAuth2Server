...
func main() {
	http.HandleFunc("/client/home", func(w http.ResponseWriter, r *http.Request) {
	...
	http.HandleFunc("/client/oauth2", func(w http.ResponseWriter, r *http.Request) {
		r.ParseForm()
	...
	http.HandleFunc("/client/refresh", func(w http.ResponseWriter, r *http.Request) {
		if globalToken == nil {
			http.Redirect(w, r, "/client/home", http.StatusFound)
			return
		}
	...
	log.Println("Client is running at 9094 port.Please open http://localhost:8080")
